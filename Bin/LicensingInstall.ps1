<#
.SYNOPSIS
    This script installs the LM-X license server and configures the license.

.DESCRIPTION
    The script removes old versions of the LM-X license server, installs the new version, moves the license file to the correct location, and starts the service.
    It also configures HAL if specified in the Setup.json file and logs the process.
